...
def _seed_initial_data(session: Session) -> None:
    ...
    sub_fs = Subdiscipline(name="Food Security", description="Studies on food security in PR")
    sub_nt = Subdiscipline(name="Nutrition", description="Human nutrition research")

    res_ana  = Researcher(fname="Ana",  lname="Torres", education="PhD", phone=7875550001, email="ana.torres@example.com")
    res_luis = Researcher(fname="Luis", lname="Ramos",  education="MSc", phone=7875550002, email="luis.ramos@example.com")
